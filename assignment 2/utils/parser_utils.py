...
def load_and_preprocess_data(reduced=True):
    ...
    train_set = read_conll(r"D:\dev\github\CS224N\assignment 2\data\train.conll",
                           lowercase=config.lowercase)
    # dev_set = read_conll(os.path.join(config.data_path, config.dev_file),
    #                      lowercase=config.lowercase)
    dev_set = read_conll(r"D:\dev\github\CS224N\assignment 2\data\dev.conll",
                         lowercase=config.lowercase)
    # test_set = read_conll(os.path.join(config.data_path, config.test_file),
    #                       lowercase=config.lowercase)
    test_set = read_conll(r"D:\dev\github\CS224N\assignment 2\data\test.conll",
                          lowercase=config.lowercase)
    if reduced:
    ...
    for line in open(r"D:\dev\github\CS224N\assignment 2\data\en-cw.txt").readlines():
        sp = line.strip().split()
